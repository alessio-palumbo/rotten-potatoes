...
movie1 = Movie.create!(title: 'Thor Ragnarok', description: 'Thor is imprisoned on the other side of the universe without his mighty hammer and finds himself in a race against time to get back to Asgard to stop Ragnarok--the destruction of his homeworld and the end of Asgardian civilization--at the hands of an all-powerful new threat, the ruthless Hela. But first he must survive a deadly gladiatorial contest that pits him against his former ally and fellow Avenger--the Incredible Hulk!', year_released: '2017', genre: 'Adventure', content_rating: 'PG-13')
movie2 = Movie.create!(title: 'Ingrid goes west', description: 'Ingrid Thorburn (Aubrey Plaza) is an unhinged social media stalker with a history of confusing "likes" for meaningful relationships. Taylor Sloane (Elizabeth Olsen) is an Instagram-famous "influencer" whose perfectly curated, boho-chic lifestyle becomes Ingrid\'s latest obsession. When Ingrid moves to LA and manages to insinuate herself into the social media star\'s life, their relationship quickly goes from BFF to WTF. Built around a brilliantly disarming performance from Aubrey Plaza, Ingrid Goes West (winner of the Waldo Salt Screenwriting Award at Sundance) is a savagely hilarious dark comedy that satirizes the modern world of social media and proves that being perfect isn\'t all it\'s cracked up to be.', year_released: '2017', genre: 'Comedy', content_rating: 'PG-13')
